...
class PenaltyDetailPage extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final penalties = ref.watch(pp.penaltiesProvider);
    final penalty = penalties.firstWhere(
      (p) => p.id == this.penalty.id,
      orElse: () => this.penalty,
    );
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                penalty.description == '' || penalty.description == null
                    ? Container()
                    : Padding(
                  ...
                  children: [
                    Container(
                      ...
                      child: Text(
                        ...
                        style: TextStyle(
                          color:
                              isAbsenceSelected ? Colors.black45 : Colors.black,
                        ),
                      ),
                    ),
                    Text('-'),
                    Container(
                      ...
                      child: Text(
                        DateFormat('HH:mm').format(correspondingReason.endDate),
                        style: TextStyle(
                          color:
                              isAbsenceSelected ? Colors.black45 : Colors.black,
                        ),
                    ...
                    Text(
                      _getDurationText(
                        correspondingReason.startDate,
                        correspondingReason.endDate,
                      ),
                      style: TextStyle(
                        color:
                            isAbsenceSelected ? Colors.black45 : Colors.black,
