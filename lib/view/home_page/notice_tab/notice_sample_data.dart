...
final List<NoticePost> sampleNotices = [
  NoticePost(
  ...
  NoticePost(
    ...
    category: '공지',
    content: '월간 모의평가 일정에 대한 공지 내용입니다.',
  ),
  NoticePost(
    title: '1:1 채팅 시 주의사항 필수 지침서',
    date: DateTime(2024, 7, 20),
    category: '공지',
    content: '1:1 채팅 시 주의사항에 대한 지침서 내용입니다.',
  ),
  NoticePost(
    title: '자습실 공사 안내 일정',
    date: DateTime(2024, 7, 15),
    category: '공지',
    content: '자습실 공사 안내 일정에 대한 내용입니다.',
  ),
  NoticePost(
    title: '2025 하반기 모의고사 테스트 안내',
    date: DateTime(2024, 7, 26),
